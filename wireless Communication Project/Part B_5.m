...
title('The number of cells versus user density , SIR = 19 dB','FontSize',14,'FontWeight','bold')
...
plot(user_dens,R)
grid on
title('Cell Radius versus user density , SIR = 19 dB','FontSize',12,'FontWeight','bold')
xlabel('User density','FontSize',12,'FontWeight','bold','Color','r')
